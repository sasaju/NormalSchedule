...
package com.liflymark.normalschedule.logic.utils.coil.transform
...
import com.liflymark.normalschedule.logic.utils.coil.util.safeConfig
import com.liflymark.normalschedule.logic.utils.coil.bitmap.BitmapPool
...
//    fun key(): String = "${BlurTransformation::class.java.name}-$radius-$sampling"

    override suspend fun transform(input: Bitmap, size: Size): Bitmap {
        val paint = Paint(Paint.ANTI_ALIAS_FLAG or Paint.FILTER_BITMAP_FLAG)
        val pool = BitmapPool(maxSize = 52428800)
